"""Plot CosyVoice3 benchmark results.
...
Usage:
    ...
    python plot_results.py \
        ...
        --output results/cosyvoice3_benchmark.png
...
def plot_single_summary(results: list[dict], label: str, output_path: str):
    ...
    fig.suptitle(f"CosyVoice3 Benchmark - {label}", fontsize=15, fontweight="bold")
...
def parse_args():
    parser = argparse.ArgumentParser(description="Plot CosyVoice3 benchmark results")
    parser.add_argument(
    ...
    parser.add_argument("--output", type=str, default="results/cosyvoice3_benchmark.png", help="Output image path")
    parser.add_argument("--title", type=str, default="CosyVoice3", help="Title prefix for the plot")
